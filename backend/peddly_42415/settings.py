"""
Django settings for peddly_42415 project.
...
ROOT_URLCONF = 'peddly_42415.urls'
...
WSGI_APPLICATION = 'peddly_42415.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "peddly_42415 API",
    "DESCRIPTION": "API documentation for peddly_42415 App",
    "VERSION": "v1",
}
